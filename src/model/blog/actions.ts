...
import { toHeading } from "./Headings";
...
async function savePost(
  ...
  try {
    ...
    headings && await Model.Heading.insertMany(headings.map(h => ({ ...h, blogId })));
