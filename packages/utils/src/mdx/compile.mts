...
type HAncestor3 = string | null;
type HAncestor4 = string | null;
type HAncestor5 = string | null;

type HChildren2 = string[] | null;
type HChildren3 = string[] | null;
type HChildren4 = string[] | null;
...
type Heading3Children = [H[], undefined, undefined, string, HChildren4, HChildren5, HChildren6]
type Heading4Children = [H[], undefined, undefined, undefined, string, HChildren5, HChildren6]
type Heading5Children = [H[], undefined, undefined, undefined, undefined, string, HChildren6]
type Heading6Children = [H[], undefined, undefined, undefined, undefined, undefined, string]

type Heading1Ancestors = [undefined, string]
type Heading2Ancestors = [undefined, HAncestor1, string]
type Heading3Ancestors = [undefined, HAncestor1, HAncestor2, string]
type Heading4Ancestors = [undefined, HAncestor1, HAncestor2, HAncestor3, string]
type Heading5Ancestors = [undefined, HAncestor1, HAncestor2, HAncestor3, HAncestor4, string]
type Heading6Ancestors = [undefined, HAncestor1, HAncestor2, HAncestor3, HAncestor4, HAncestor5, string]
